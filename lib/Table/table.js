...
var Table = function (_Component) {
  ...
  _createClass(Table, [{
    ...
    value: function getTableSettings(rawData) {
      ...
      var headers = data.reduce(function (headers, rec) {
    ...
    value: function getTable() {
      ...
      var columns = rawData.reduce(function (headers, rec) {
        /*
      ...
      var data = rawData.map(function (item, rowIndex) {
        return columns.reduce(function (row, field) {
          var value = field.key === '#' ? rowIndex + 1 : typeof item[field.key] !== 'undefined' ? _this3.getDisplayValue(item[field.key], item) : '';
          return Object.assign({}, row, _defineProperty({}, field.key, value));
        }, {});
      });
