...
Table.propTypes = {
  ...
  filterable: _propTypes2.default.boolean,
  showPagination: _propTypes2.default.boolean,
  showPaginationBottom: _propTypes2.default.boolean,
  showPaginationTop: _propTypes2.default.boolean
};
;
