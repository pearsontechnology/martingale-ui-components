...
var _checkboxtable = require('./checkboxtable');
...
var Table = function (_Component) {
  ...
  _createClass(Table, [{
    ...
    value: function componentWillReceiveProps(newProps) {
      if (newProps.data && !(0, _utils.isTheSame)(this.state.data, newProps.data)) {
    ...
    value: function getTable() {
      ...
      var _props = this.props,
          ...
          _props$selectableRows = _props.selectableRows,
          selectableRows = _props$selectableRows === undefined ? false : _props$selectableRows;

      var TableComponent = selectableRows ? _checkboxtable.CheckboxTable : _reactTable2.default;
      return _react2.default.createElement(TableComponent, Object.assign({}, this.props, {
