...
var ViewContents = function ViewContents(_ref) {
  ...
  var wrap = function wrap(children, _ref2) {
    ...
    return _react2.default.createElement(_tabs.Tabs, (_React$createElement = { inset: inset, tabs: tabs }, _defineProperty(_React$createElement, 'inset', false), _defineProperty(_React$createElement, 'footer', footerContents), _React$createElement));
  };
  if (dataType === 'array') {
