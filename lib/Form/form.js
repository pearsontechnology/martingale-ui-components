...
var BaseForm = function (_Component) {
  ...
  _createClass(BaseForm, [{
    ...
    value: function onSubmit(_ref) {
      ...
      //const rawOrgData = orgData||orgFormData;

      var rawOrgData = this.getPropData();
      //const rawData = rawOrgData?Object.assign({}, rawOrgData, formData):formData;
      //const data = mapper?mapper(rawData):rawData;
      ...
      if (submitTo) {
        var _ref2 = typeof submitTo === 'string' ? { url: submitTo } : submitTo,
            ...
            url = _ref2.url,
            _mapper = _ref2.mapper;

        return (0, _martingaleUtils.fetchJson)({
          url: url,
          method: method,
    ...
    value: function render() {
      var _props4 = this.props,
          ...
          props = _objectWithoutProperties(_props4, ['children', 'schemaEncoder', 'schema', 'stripInvalid']);
