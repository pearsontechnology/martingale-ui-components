...
var creaetActionHandler = function creaetActionHandler(actionName, action, dialog) {
  if (!action) {
...
var getDialogFooter = function getDialogFooter(footer, actions, dialog) {
  ...
  if (actions) {
    var actionButtons = Object.keys(actions).map(function (actionName) {
      ...
      return _react2.default.createElement(
        'button',
        { key: actionName, onClick: creaetActionHandler(actionName, action, dialog), className: 'btn btn-' + (action.btnStyle || 'primary') },
        actionName
      );
    });
    return _react2.default.createElement(
...
Dialog.propTypes = {
  ...
  actionsBoundTo: _propTypes2.default.object,
