...
}, _defineProperty(_Panel$propTypes, 'children', _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.element, _propTypes2.default.func])), _defineProperty(_Panel$propTypes, 'children', _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.element, _propTypes2.default.func])), _defineProperty(_Panel$propTypes, 'type', _propTypes2.default.string), _defineProperty(_Panel$propTypes, 'size', _propTypes2.default.number), _defineProperty(_Panel$propTypes, 'lg', _propTypes2.default.number), _defineProperty(_Panel$propTypes, 'md', _propTypes2.default.number), _defineProperty(_Panel$propTypes, 'sm', _propTypes2.default.number), _defineProperty(_Panel$propTypes, 'xs', _propTypes2.default.number), _defineProperty(_Panel$propTypes, 'inset', _propTypes2.default.bool), _Panel$propTypes);
