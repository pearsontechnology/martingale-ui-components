...
import IconConsumer from 'react-icons/lib/fa/beer';
import IconDashboard from 'react-icons/lib/fa/dashboard';
import IconUser from 'react-icons/lib/fa/user';
import IconSettings from 'react-icons/lib/fa/sliders';
import IconLogOut from 'react-icons/lib/fa/sign-out';
import IconInbox from 'react-icons/lib/fa/inbox';
import IconAlert from 'react-icons/lib/fa/bolt';
import IconPlugin from 'react-icons/lib/fa/plug';
import IconAPI from 'react-icons/lib/fa/code';
import IconCluster from 'react-icons/lib/fa/server';
import IconComment from 'react-icons/lib/fa/comments-o';
import IconTask from 'react-icons/lib/fa/tasks';
import IconOrder from 'react-icons/lib/fa/shopping-basket';
import IconSupport from 'react-icons/lib/fa/ambulance';
import IconCalendar from 'react-icons/lib/fa/calendar-o';
import IconNote from 'react-icons/lib/fa/sticky-note-o';
import IconBilling from 'react-icons/lib/fa/money';
